...
- [Contributing to the Growth & Marketing Committee documentation](#contributing-to-the-growth-marketing-documentation)
...
1. **Fork the repository:**
   - Navigate to  https://github.com/intersectmbo/growth-marketing-documentation
...
2. **Clone the fork:**
   ...
   - Run the following command to clone the repository:
     ```shell
     git clone https://github.com/intersectmbo/growth-marketing-documentation.git
     ```

3. **Navigate to the Project Directory:**
   - After cloning, change into the project's root directory:
     ```shell
     cd growth-marketing-documentation
     ```
